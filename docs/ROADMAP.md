...
4. [ ] **Active priority — [#81 — Resolve final Fast FCF reliability gate and non-overlapping denominator](https://github.com/firaolwola/stock-research/issues/81).** The approved five-case confirmation is complete, but strict usable FCF coverage was 2/5 and the frozen same-five denominator remains 3/5. Keep cohorts non-overlapping, preserve Limited/Unscored unavailable evidence, and reassess #55 only after documenting whether another independently approved FCF evidence cohort is needed.
