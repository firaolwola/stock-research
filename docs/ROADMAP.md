...
8. [ ] **Active — final reliability/sample-size adjudication:** [#55 — Calibrate evidence-first Fast reliability on real tickers](https://github.com/firaolwola/stock-research/issues/55). The offline adversarial/property loop passes; AMC, NCPL, ONFO, and STN targeted corrections are confirmed for their covered shapes; and practical samples reach 5 completed splits, 3 active deficiencies, 4 going-concern/bankruptcy cases, 3 foreign/ADR/IFRS cases, and 5 OTC/delisted cases. The offline reverse-split adjudication confirms 15/15 canonical events across five independent cases with zero severe misses. The owner-approved policy now accepts unavailable or accounting-invalid FCF as a safe coverage-limited outcome when the report remains Limited/Unscored; numeric FCF coverage is still reported separately at 2/5 and frozen same-five measurements remain unchanged. Overall closure still cannot be claimed because overlapping rubrics do not support a single pooled recall number and broad score/explanation reliability is not established. NIO attributable annual net loss remains `unavailable_authoritative_evidence`, not a system miss. The bounded SEC filing-table FCF coverage (#76), score calibration (#77), final adjudication (#78), bounded Issue #81 confirmation, and coverage-limited gate decision are complete; PR #74 remains not merge-ready. See `docs/results/FAST_RELIABILITY_2026-08-31-FINAL-ADJUDICATION.md`, `evaluation/diagnostics/fast-reverse-split-adjudication-2026-08-31.json`, and `evaluation/live/2026-08-31-fcf-gate-confirmation-1/summary.json`.
