...
8. [ ] **Active — correct live MULN lifecycle/date association offline:** [#55 — Calibrate evidence-first Fast reliability on real tickers](https://github.com/firaolwola/stock-research/issues/55). Batch 3 reached 83/86 material checks (96.51%). Sparse-5 remained at 14/16 (87.5%). The corrected-runner MULN verification produced a valid report and retrieved all three frozen ratio/date pairs, but two remained unresolved and a prior 1-for-100 ratio borrowed the August 4, 2025 1-for-250 action date. NIO remains correctly Limited under unavailable authoritative evidence. No additional live run or expansion is authorized.
