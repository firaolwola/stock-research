...
4. [ ] **Active priority — [#81 — Resolve final Fast FCF reliability gate and non-overlapping denominator](https://github.com/firaolwola/stock-research/issues/81).** The approved five-case confirmation and offline coverage audit are complete: strict usable FCF coverage was 2/5 (coverage unproven), safe unresolved settlement was 5/5 (safety gate passed), no captured filing-table capex record was discarded, and the frozen same-five denominator remains 3/5. Keep cohorts non-overlapping and preserve Limited/Unscored unavailable evidence; do not repeat paid same-five runs without a newly demonstrated parser gap or separately approved denominator decision.
