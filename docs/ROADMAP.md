...
8. [ ] **Active — MULN verification blocked by runner lifecycle failure:** [#55 — Calibrate evidence-first Fast reliability on real tickers](https://github.com/firaolwola/stock-research/issues/55). Batch 3 reached 83/86 material checks (96.51%). Sparse-5 remained at 14/16 (87.5%) with 4/4 valid reports and 4/4 safe settlement. Offline regressions correct the reproduced MULN shape, but the approved MULN-only process returned no report because its dedicated runner omitted the established keep-alive guard. It was not retried. NIO remains correctly Limited under unavailable authoritative evidence. No additional live run or expansion is authorized.
