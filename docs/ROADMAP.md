...
8. [ ] **Active — await owner decision on one final MULN verification:** [#55 — Calibrate evidence-first Fast reliability on real tickers](https://github.com/firaolwola/stock-research/issues/55). Batch 3 reached 83/86 material checks (96.51%). Sparse-5 remained at 14/16 (87.5%). The corrected-runner live result exposed MULN lifecycle/date association defects; stored-live regressions now complete all three 2023 actions, preserve the real August 4, 2025 1-for-250 action, and suppress the false same-date 1-for-100 action. NIO remains correctly Limited under unavailable authoritative evidence. No additional live run or expansion is authorized.
