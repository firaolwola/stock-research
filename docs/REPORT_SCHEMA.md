...
confirmed/not-found claims, and consistency between complete status and coverage
limitations.

The complete fixture demonstrates all initial trustworthy-report sections,
confirmed lineage, dated primary evidence, and distinct score dimensions. The
partial fixture demonstrates an ADR, deep/partial status, unresolved lineage,
