...
const unknownMetric = (label) => ({ state: "unknown", label, value: null, unit: null, period_start: null, period_end: null, trend: "unknown", comparison_period_start: null, comparison_period_end: null, observations: [], summary: `${label} was not established by completed Fast evidence.`, claim_ids: [] });
