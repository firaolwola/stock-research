export const RESEARCH_STAGES = Object.freeze({
  fast: Object.freeze({ stage: "fast", target_latency_ms: Object.freeze({ min: 3_000, max: 10_000 }), timeout_ms: 15_000, max_output_tokens: 5_000, target_cost_usd: 0.10 }),
  deep: Object.freeze({ stage: "deep", target_latency_ms: null, timeout_ms: 60_000, max_output_tokens: 10_000, target_cost_usd: null })
});
...
export function buildResearchOperations({ stage, latencyMs, usage = null, webSearchCalls = 0, pricing = PRICING_SNAPSHOT }) {
  ...
  return {
    ...
    within_latency_target: stage === "fast" ? latencyMs >= budget.target_latency_ms.min && latencyMs <= budget.target_latency_ms.max : null,
