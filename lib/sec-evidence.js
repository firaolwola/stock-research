...
import { extractSecFilingEvidenceWithDiagnostics, filingHtmlToText, findMaterialExhibitUrls, normalizeCatalystClassification } from "./sec-filing-extraction.js";
...
function financialFragment(identity, companyFacts, retrievedAt, records) {
  ...
  if (fcfPair) {
    ...
    const fcf = { ...alignedOcf, val: alignedOcf.val - Math.abs(alignedCapex.val), label: "Free cash flow" };
