...
function financialFragment(identity, companyFacts, retrievedAt, records) {
  ...
  return { domain: "financial", identity, dividends: unknownSection("Dividend status was not established from Company Facts.", "Dividend and security-specific applicability retrieval remains deferred."), financial_assessment: { state: "limited_coverage", as_of: retrievedAt.slice(0, 10), reporting_currency: null, summary: newestPeriod ? `Latest standardized SEC facts are shown through ${newestPeriod}; document-level interpretation remains bounded.` : "No standardized current SEC financial period was established.", coverage_notes: coverageNotes, metrics, going_concern: { state: "unknown", as_of: null, summary: "Going-concern language was not established from bounded filing extraction.", claim_ids: [] }, material_warnings: warnings }, claims, sources };
}
