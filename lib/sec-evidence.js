...
function applyExtractedFindings(fragments, findings, retrievedAt, records, corporateActionDiagnostics = []) {
  ...
  const financial = fragments.financial; const warnings = byDomain.financial.filter((item) => ["going_concern", "bankruptcy", "accounting_warning", "non_reliance", "working_capital_deficit", "debt_maturity"].includes(item.kind));
